...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'techvents_userevent', (
            (u'event_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['swingtime.Event'], unique=True, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_profile', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'techvents', ['UserEvent'])


    def backwards(self, orm):
        # Deleting model 'UserEvent'
        db.delete_table(u'techvents_userevent')
    ...
    models = {
        ...
        u'techvents.userevent': {
            'Meta': {'ordering': "('title',)", 'object_name': 'UserEvent', '_ormbases': [u'swingtime.Event']},
            u'event_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['swingtime.Event']", 'unique': 'True', 'primary_key': 'True'}),
