...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.event'
        db.add_column(u'userprofile_userprofile', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['swingtime.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.event'
        db.delete_column(u'userprofile_userprofile', 'event_id')
